...
TEXT = os.environ.get("WORDMARK_TEXT", "MS")
...
TITLE_TEXT = "#7d8590"
INK = "#c9d1d9"
FONT_PATH = os.environ.get("WORDMARK_FONT", "C:/Windows/Fonts/arial.ttf")
...
def emit(frames, mode, out, dur, reveal):
    ...
    p.append(f'<text x="{canvas_w/2:.0f}" y="{TITLEBAR_H/2 + 4:.0f}" fill="{TITLE_TEXT}" '
             f'font-size="11.5" text-anchor="middle">mridul@github: ~$ ./wordmark.sh --3d</text>')
